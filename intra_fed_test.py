...
if __name__ == '__main__':
    ...
    for i in range(config.TRAIN.global_ep):
        ...
        for j in range(config.TRAIN.num_users):
            # po.append(w_glob)
            local_state,mean_training_losses,mean_valid_losses=moedl_trainer.Fed_intra_train(datadict_list[j],config.TRAIN.local_ep,copy.deepcopy(w_glob),j,i,config,datadict_list,global_datadict)
